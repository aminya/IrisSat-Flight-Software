...
set_compile_info \
    -category {"Source Files"} \
    -name {"Source"} \
    -value {"C:\Users\Joseph Howarth\Documents\MBSat\cdh-tsat5\cdh-tsat5-libero\synthesis\cdh_tsat5_system.edn"}
set_compile_info \
    -category {"Options"} \
...
set_compile_info \
    ...
    -value {"10"}
compile \
    -desdir {C:\Users\Joseph Howarth\Documents\MBSat\cdh-tsat5\cdh-tsat5-libero\designer\cdh_tsat5_system} \
